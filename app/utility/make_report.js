...
function generateDeviceInformation(doc, report_detail, top_position) {
  ...
  doc
    ...
    .font(PalatinoBold)
    .text("Device Location:", 300, top_position + 60) // Adjusted position for Device Location
    .font("Helvetica-Bold")
    .text(report_detail.location || "N/A", 430, top_position + 60) // Adjusted position for Device Location
